...
@section('content_app')
    <div class="container shopping">
        <div class="row">
                        ...
                        <ul class="card__body--checkout checkout">
                            <li class="checkout__item">
                                ...
                                <div class="checkout__item--content">
                                    ...
                                    <p class="checkout__item--content-text">Vui lòng kiểm tra lại thông tin giao hàng để đảm
                                        bảo chính xác.</p>
                                    <div class="shipping">
                            ...
                            <li class="checkout__item">
                                ...
                                <div class="checkout__item--content">
                                    <div class="row">
                                        ...
                                        <p class="checkout__item--content-text">Thông tin thanh toán của bạn sẽ được bảo mật
                                            tuyệt đối.</p>
                                    </div>
                                            ...
                                            <div class="optionPayment__method--item method">
                                                ...
                                                <div class="method__content">
                                                    <div class="method__content--image">
                                                        ...
                                                        <img src="{{ asset('images/Logo-VNPAY-QR.png') }}" alt="">
                                                    </div>
            ...
            <div class="checkout-summary col-xl-4">
