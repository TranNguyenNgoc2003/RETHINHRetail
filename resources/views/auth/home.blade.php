                                ...
                                <div class="right">
                                    <div class="right__thumb">
                                        <div class="right__thumb--inner">
                                            ...
                                            <span class="right__thumb--inner-description">Thiết kế sang trọng - Theo dõi sức khỏe</span>
                                        </div>
                                        <div class="right__thumb--hover hover">
                                            <div class="hover__inner">
                                                <h4 class="hover__inner--title">Đồng hồ thông minh</h4>
                                                <p class="hover__inner--description">Nhận thông báo, theo dõi sức khỏe và nâng cao trải nghiệm sống.</p>
                                                <div class="hover__inner--button">
                                                    <a href="#">Tìm hiểu thêm</a>
                                                </div>
                                            </div>
                                ...
                                <div class="right">
                                    <div class="right__thumb">
                                        <div class="right__thumb--inner">
                                            ...
                                            <span class="right__thumb--inner-description">Công nghệ tiên tiến - Hiển thị sắc nét</span>
                                        </div>
                                        <div class="right__thumb--hover hover">
                                            <div class="hover__inner">
                                                <h4 class="hover__inner--title">PC &amp; Màn hình</h4>
                                                <p class="hover__inner--description">Hiệu suất mạnh mẽ, phù hợp cho công việc và giải trí.</p>
                                                <div class="hover__inner--button">
                                                    <a href="#">Tìm hiểu thêm</a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="right__thumb">
                                        ...
                                        <div class="right__thumb--hover hover">
                                            <div class="hover__inner">
                                                ...
                                                <p class="hover__inner--description">Bảo vệ thiết bị và nâng cao trải nghiệm sử dụng.</p>
                                                <div class="hover__inner--button">
                                                    <a href="#">Tìm hiểu thêm</a>
                                                </div>
                                            </div>
